...
if (isset($_POST['update_profile'])) {
    ...
    $update_query = "UPDATE users SET full_name = '$new_name' WHERE user_id = '$user_id'";
...
if (isset($_POST['change_password'])) {
    ...
    $check_query = "SELECT password_hash FROM users WHERE user_id = '$user_id'";
    ...
    if (password_verify($old_pass, $user_data['password_hash'])) {
        if ($new_pass === $conf_pass) {
            ...
            $update_pass_query = "UPDATE users SET password_hash = '$new_hash' WHERE user_id = '$user_id'";
