    ...
    <section class="categories-section">
        <div class="container">
            ...
            <div class="category-cards">
                <div class="cat-card">
                    <img src="assets/images/plastic.png" alt="Plastic">
                    ...
                    <?php while ($item = mysqli_fetch_assoc($recentItems)): ?>
                        <div class="product-card">
                            <div class="product-img">
                                ...
                                <?php else: ?>
                                    <img src="https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=400&h=300&fit=crop"
                                        alt="Waste Item">
                                <?php endif; ?>
        ...
        <div class="container">
            <div class="benefits-content">
                ...
                <div class="benefits-image">
                    <img src="https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=600&h=500&fit=crop"
                        alt="Recycling">
                </div>
            </div>
        </div>
